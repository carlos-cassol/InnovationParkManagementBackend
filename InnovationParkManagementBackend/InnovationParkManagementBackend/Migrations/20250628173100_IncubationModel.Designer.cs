...
namespace InnovationParkManagementBackend.Migrations
{
    ...
    [Migration("20250628173100_IncubationModel")]
    partial class IncubationModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InnovationParkManagementBackend.Domain.Entities.CardFile", b =>
                {
                    ...
                    b.HasOne("InnovationParkManagementBackend.Domain.Entities.Card", null)
                        .WithOne("PaymentReceipt")
                        .HasForeignKey("InnovationParkManagementBackend.Domain.Entities.CardFile", "CardId1");
